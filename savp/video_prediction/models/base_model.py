...
class BaseVideoPredictionModel(object):
    ...
    def get_default_hparams_dict(self):
        ...
        Returns:
            ...
            eval_length: default value is sequence_length - context_frames.
                The number of generated frames to be evaluated with metrics
                or appeared in generated GIFs.
    ...
    def eval_outputs_and_metrics_fn(self, inputs, outputs, num_samples=None,
        ...
        context_frames = self.hparams.context_frames
        future_length = sequence_length - context_frames
        # explicitly set the eval_length if specified
        if self.hparams.eval_length != -1:
            future_length = self.hparams.eval_length
